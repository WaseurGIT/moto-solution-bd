  ...
  return (
    <aside className="w-full h-full bg-blue-100 p-3 sm:p-4 overflow-y-auto">
      ...
      <div className="flex flex-col space-y-2 md:space-y-5 mt-6 md:mt-8">
        ...
        >
          <FaUser className="text-lg md:text-xl text-blue-500 flex-shrink-0" />
        ...
        >
          <MdNoteAlt className="text-lg md:text-xl text-blue-500 flex-shrink-0" />
          <span className="text-xs md:text-base text-blue-500 font-medium hover:text-blue-700">My Service Bookings</span>
        </Link>
        ...
        <Link
          ...
          className="flex items-center gap-2 md:gap-3 px-2 md:px-3 py-2 md:py-2.5 rounded hover:bg-blue-200 transition"
        >
          <FaCarSide className="text-lg md:text-xl text-blue-500 flex-shrink-0" />
          <span className="text-xs md:text-base text-blue-500 font-medium hover:text-blue-700">Book a Vehicle</span>
        </Link>
        ...
        >
          <FaCarSide className="text-lg md:text-xl text-blue-500 flex-shrink-0" />
          <span className="text-xs md:text-base text-blue-500 font-medium hover:text-blue-700">My Vehicle Bookings</span>
        </Link>
