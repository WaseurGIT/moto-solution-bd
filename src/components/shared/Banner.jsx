...
const Banner = () => {
  ...
  return (
    <div className="max-w-full  flex justify-center items-center py-6 sm:py-8 md:py-12">
      <div className="relative h-48 sm:h-64 md:h-96 lg:h-[500px] xl:h-[600px] overflow-hidden rounded-lg shadow-2xl w-full mx-3 sm:mx-4 lg:mx-auto lg:w-5/6 max-w-7xl">
        <div
